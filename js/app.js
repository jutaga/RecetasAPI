/* 
    API CATEGORIA = https://www.themealdb.com/api/json/v1/1/categories.php
    API FILTRO = https://www.themealdb.com/api/json/v1/1/filter.php?c=Beef
    API INGREDIENTES = https://themealdb.com/api/json/v1/1/lookup.php?i=52772
*/
...
function iniciarApp() {
    ...
    function mostrarRecetaModal(receta) {
        ...
        modalBody.innerHTML = `
            ...
            <p>${strInstructions}</p>
            <h3 lass="my-3"> Ingredientes y Cantidades</h3>
        `;
